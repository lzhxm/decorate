...
@interface StyleViewController ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
- (void)viewDidLoad {
    ...
    _numArray = @[@"简欧",@"现代",@"中式",@"欧式",@"美式",@"田园",@"新古典",@"混搭",@"地中海",@"东南亚",@"日式",@"宜家",@"北欧",@"简约"];
    NSDictionary *dcit = @{@"action":@"list",@"appid":@"16",@"appostype":@"2",@"appversion":@"3.1.2",@"channel":@"appstore",@"color":@"0",@"idfa":@"08F4DBAA-BE1E-42A2-BAD0-58732545CB88",@"local":@"0",@"model":@"images",@"page":@"1",@"paging":@"1",@"perPage":@"20",@"space":@"0",@"style":@"",@"systemversion":@"9.2",@"t8t_device_id":@"33B422E8-3150-45BB-9744-05C2D3F33DFC&",@"to8to_token":@"",@"uid":@"0",@"version":@"2.5"};
    ...
    HeadView *headView = [[HeadView alloc] initWithHeadView:@"风格" backgroundImg:[UIImage imageNamed:@"head"]];
