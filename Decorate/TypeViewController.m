...
- (void)viewDidLoad {
    ...
    _numArray =@[@"小户型",@"一居",@"二居",@"三居",@"四居",@"复式",@"别墅",@"公寓",];
    NSDictionary *dcit = @{@"action":@"list",@"appid":@"16",@"appostype":@"2",@"appversion":@"3.1.2",@"area":@"0",@"channel":@"appstore",@"color":@"0",@"homeType":@"",@"idfa":@"08F4DBAA-BE1E-42A2-BAD0-58732545CB88",@"model":@"imagessets",@"page":@"1",@"paging":@"1",@"perPage":@"20",@"style":@"0",@"systemversion":@"9.2",@"t8t_device_id":@"33B422E8-3150-45BB-9744-05C2D3F33DFC",@"to8to_token":@"",@"uid":@"0",@"version":@"2.5"};
    ...
    HeadView *headView = [[HeadView alloc] initWithHeadView:@"户型" backgroundImg:[UIImage imageNamed:@"head"]];
    ...
    backButton.frame = CGRectMake(0, _headViewHeight/3, _headViewHeight/1.5, _headViewHeight/1.5);    [backButton setImage:[UIImage imageNamed:@"btn_back_on@2x"] forState:UIControlStateNormal];
...
- (void)URLRequest:(UIButton *)button{
    ...
    switch (button.tag) {
        case 0:
            _dataDict[@"homeType"] = @"1";
            break;
        case 1:
            _dataDict[@"homeType"] = @"7";
            break;
        case 2:
            _dataDict[@"homeType"] = @"2";
            
            break;
        case 3:
            _dataDict[@"homeType"] = @"3";
            
            break;
        case 4:
            _dataDict[@"homeType"] = @"4";
            
            break;
        case 5:
            _dataDict[@"homeType"] = @"5";
            
            break;
        case 6:
            _dataDict[@"homeType"] = @"6";
            
            break;
        case 7:
            
            _dataDict[@"homeType"] = @"8";
